...
function initRouter(body) { 
	...
	fragment = [
		...
		`				{/*按钮*/}`,
		`				<BtnWrap>`,
		`					<Button fType="add" onClick={() => updateNewWindow()}>新增</Button>`,
		`					<Button disabled={selectedRowKeys.length == 0} fType="delete" onClick={deleteItems}>删除</Button>`,
		`				</BtnWrap>`,
		`				<TableWrap top={48}>`,
